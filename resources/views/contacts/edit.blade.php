            ...
            <div class="max-w-2xl mx-auto mt-10">
                ...
                <form action="{{ route('contact.update', ['id' => $contact->id]) }}" method="post">
                    ...
                    <div class="mb-3">
                            ...
                            <input name="name" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="name" placeholder="Type your name" value="{{ $contact->name }}"
                                   >
                    ...
                    <div class="mb-3">
                        <div class="col">
                            ...
                            <input name="email" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="email" placeholder="Type your pass" value="{{ $contact->email }}"
                                   >
                            <div class="invalid-feedback">
                                @error('email')
                                <span class="text-xs leading-5 text-red-600">{{ $message }}</span>
