...
@section('content')
    ...
    <div class="w-full relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="w-full flex items-center justify-between mb-5 px-5">
            <header>
                <h1 class="text-center text-gray-800 text-4xl font-bold py-3">Contact List</h1>
            </header>
            <a href="{{ route('auth.login') }}" class="w-28 rounded bg-green-500 py-3 px-5 text-gray-800 cursor-pointer">Manager</a>
        </div>
        @if(session('success'))
            <div class="w-2/3 mx-auto bg-indigo-100 border border-indigo-400 text-indigo-400 px-4 py-2 rounded relative"
                 role="alert">
